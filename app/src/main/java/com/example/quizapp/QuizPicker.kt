...
class QuizPicker(position: Int) {
    val selected = when(position) {
        0 -> QuizData(arrayListOf(QuestionData("Question 0", "option1", "option2", "option3", "option4", Option.ONE),
            QuestionData("Question 1", "option1", "option2", "option3", "option4", Option.TWO)))
